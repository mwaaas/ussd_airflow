.. Ussd Airflow documentation master file, created by
...
It can be intergrated with any gui to create ussd application using Gui
...
The following list contains all major sections of Ussd Airflow prose (non-API)
...
Ussd Airflow maintains two sets of API documentation, autogenerated from the source
...
which form the basic building blocks of Ussd Airflow (such as
